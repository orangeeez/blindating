...
namespace ASPAngular2Test.Migrations
{
    public partial class AddPhotoTable2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_Photo_InformationUser_InformationFK", table: "Photo");
            migrationBuilder.DropForeignKey(name: "FK_Quote_InformationUser_InformationFK", table: "Quote");
            migrationBuilder.DropColumn(name: "InformationFK", table: "Photo");
            migrationBuilder.AddColumn<int>(
                name: "InformationPhotoFK",
                table: "Photo",
                nullable: false,
                defaultValue: 0);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_Quote_InformationUser_InformationFK", table: "Quote");
            migrationBuilder.DropColumn(name: "InformationPhotoFK", table: "Photo");
            migrationBuilder.AddColumn<int>(
                name: "InformationFK",
                table: "Photo",
                nullable: false,
            ...
            migrationBuilder.AddForeignKey(
                ...
                onDelete: ReferentialAction.Restrict);
            migrationBuilder.AddForeignKey(
                name: "FK_Photo_InformationUser_InformationFK",
                table: "Photo",
                column: "InformationFK",
                principalTable: "InformationUser",
                principalColumn: "ID",
