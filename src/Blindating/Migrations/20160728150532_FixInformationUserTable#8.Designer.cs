...
namespace ASPAngular2Test.Migrations
{
    ...
    [Migration("20160728150532_FixInformationUserTable#8")]
    partial class FixInformationUserTable8
    {
            ...
            modelBuilder.Entity("ASPAngular2Test.Models.InformationUser", b =>
                {
                    b.HasOne("ASPAngular2Test.Models.User")
                        .WithOne()
                        .HasForeignKey("ASPAngular2Test.Models.InformationUser", "UserForeignKey");
                });
