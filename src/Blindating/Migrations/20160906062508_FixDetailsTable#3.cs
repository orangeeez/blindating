...
{
    public partial class FixDetailsTable3 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "PrefferdLanguage", table: "Detail");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_Question_InformationUser_InformationQuestionFK", table: "Question");
            migrationBuilder.DropForeignKey(name: "FK_Quote_InformationUser_InformationFK", table: "Quote");
            migrationBuilder.DropColumn(name: "Gender", table: "Detail");
            migrationBuilder.DropColumn(name: "PrefferedLanguage", table: "Detail");
            migrationBuilder.AddColumn<string>(
                name: "PrefferdLanguage",
                table: "Detail",
                nullable: true);
            migrationBuilder.AddForeignKey(
                name: "FK_InformationUser_User_UserFK",
