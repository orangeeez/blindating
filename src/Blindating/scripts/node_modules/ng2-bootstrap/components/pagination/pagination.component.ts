...
export class Pagination implements ControlValueAccessor, OnInit, IPaginationConfig, IAttribute {
  ...
  @Output() private numPages: EventEmitter<number> = new EventEmitter<number>();
  @Output() private pageChanged: EventEmitter<IPageChangedEvent> = new EventEmitter<IPageChangedEvent>();
