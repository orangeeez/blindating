System.register(['angular2/core', 'angular2/common', '../ng2-bootstrap-config', './datepicker-inner'], function(exports_1, context_1) {
    ...
    var TEMPLATE_OPTIONS, CURRENT_THEME_TEMPLATE, YearPicker;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            CURRENT_THEME_TEMPLATE = TEMPLATE_OPTIONS[ng2_bootstrap_config_1.Ng2BootstrapConfig.theme] || TEMPLATE_OPTIONS.bs3;
            YearPicker = (function () {
            ...
            exports_1("YearPicker", YearPicker);
        }
    }
});
