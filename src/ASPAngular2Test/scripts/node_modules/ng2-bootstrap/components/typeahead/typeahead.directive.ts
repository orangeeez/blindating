...
export class Typeahead implements OnInit {
    @Output() public typeaheadLoading: EventEmitter<boolean> = new EventEmitter<boolean>();
  @Output() public typeaheadNoResults:EventEmitter<boolean> = new EventEmitter<boolean>();
  @Output() public typeaheadOnSelect: EventEmitter<{ item: any }> = new EventEmitter<{ item: any }>();
