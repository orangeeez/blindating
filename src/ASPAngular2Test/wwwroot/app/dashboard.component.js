System.register(['angular2/core', 'angular2/router', './user.service', './app.component', './dashboard/dashboard'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, user_service_1, app_component_1, dashboard_1;
    ...
    return {
        ...
        execute: function() {
            DashboardComponent = (function () {
                function DashboardComponent(app, _userService, _router) {
